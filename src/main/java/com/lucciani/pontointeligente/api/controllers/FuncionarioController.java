...
import com.lucciani.pontointeligente.api.dtos.FuncionarioDto;
...
public class FuncionarioController {
	...
	private FuncionarioDto converterFuncionarioDto(Funcionario funcionario) {
		...
		funcionario.getQtHorasAlmocoOpt()
			.ifPresent(qtHorasAlmoco -> funcionarioDto.setQtHorasAlmoco(Optional.of(Float.toString(qtHorasAlmoco))));
		funcionario.getQtHorasTrabalhoDiaOpt()
			.ifPresent(qtHorasTrabalhoDia -> funcionarioDto.setQtHorasTrabalhoDia(Optional.of(Float.toString(qtHorasTrabalhoDia))));
