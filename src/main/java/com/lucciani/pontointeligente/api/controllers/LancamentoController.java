...
import com.lucciani.pontointeligente.api.dtos.LancamentoDto;
...
public class LancamentoController {
	...
	/**
	 * Retorna a listagem de lancçamentos de um funcionário.
	 * 
	 * @param funcionarioId
	 * @param pag
	 * @param ord
	...
	public ResponseEntity<Response<LancamentoDto>> listarPorId(@PathVariable("id") Long id) {
		...
		if (!lancamento.isPresent()) {
			...
			response.getErrors().add("Lançamento não encontrado com o id " + id);
	...
	public ResponseEntity<Response<String>> remover(@PathVariable("id") Long id){
		...
		if(!lancamento.isPresent()) {
			...
			response.getErrors().add("Erro ao remover lançamento. Registro não encontrado com o id"+id);
		}
	...
	/**
	 * Converte um lançamento para uma entidade Lançamento.
	 * 
	 * @param lancamentoDto
	 * @param result
	 * @return Lancamento
